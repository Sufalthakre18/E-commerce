...
const studyType = [
'Weekly Planners', 'Daily Trackers', 'Habit Trackers', 'Focus Timers', 'Progress Dashboards'
];
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
                Organize your study schedule with our range of planners and trackers designed to boost productivity and keep you on track.
            </p>
          </div>
        </div>
      </div>
