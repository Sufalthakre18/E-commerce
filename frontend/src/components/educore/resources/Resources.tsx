...
const resourcesType = [
'Practice Tests', 'Flashcards', 'Cheat Sheets', 'Revision Schedules', 'Answer Explanations'
];
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
                High-quality resources to help you excel in your exams and achieve your academic goals.
            </p>
          </div>
        </div>
      </div>
