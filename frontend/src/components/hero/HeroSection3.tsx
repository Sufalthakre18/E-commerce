...
export default function CategoryRow() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const data = await fetchWrapper(`${process.env.NEXT_PUBLIC_API_URL}/products`, { responseType: 'json' });
        if (data?.products) {
  ...
  return (
    <>
      ...
      >
        <h2 className="text-2xl md:text-3xl font-light tracking-[0.2em] uppercase text-black mb-12 md:mb-16 text-center">
...
export function HeroSection4() {
  return (
    <div className="w-full">
      <section className="py-10 md:py-12 lg:py-16 bg-stone-50">
        <div className="max-w-2xl mx-auto px-6 sm:px-8 text-center">
          {/* Minimal Heading */}
          <h2 className="text-2xl md:text-3xl font-light tracking-[0.2em] uppercase text-black mb-12 md:mb-16">
            Newsletter
