...
const kitsType = [
  'Website Templates', 'Email Templates', 'Social Media Kits', 'Presentation Templates', 'Brochures'
];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const kitsProducts = data.products.filter(
          (product) => product.category.parent?.name === 'Creative & Business' && product.category.name === 'Templates & Marketing Kits',
        );
        setProducts(kitsProducts);
      } catch (err) {
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
              Elevate your brand with our exclusive collection of templates and marketing kits, designed to make your business stand out.
            </p>
          </div>
        </div>
      </div>
