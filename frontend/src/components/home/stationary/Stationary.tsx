...
const stationaryType = [
"Notebooks", "Journals","Phone Cases"
];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const stationaryProducts = data.products.filter(
          (product) => product.category.parent?.name === 'Home' && product.category.name === 'Home-Stationary',
        );
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
              Discover our exclusive collection of stationary and more, designed to inspire creativity and enhance your everyday life. 
            </p>
          </div>
        </div>
      </div>
