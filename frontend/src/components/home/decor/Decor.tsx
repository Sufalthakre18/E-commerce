...
const decorType = [
"Canvas Prints","Posters","Acrylic Posters","Framed Art","Stickers","Coasters","Notepads"
];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const decorProducts = data.products.filter(
          (product) => product.category.parent?.name === 'Home' && product.category.name === 'Home-Decor',
        );
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
              Explore our exclusive range of decor items to elevate your living space with style and comfort.
            </p>
          </div>
        </div>
      </div>
