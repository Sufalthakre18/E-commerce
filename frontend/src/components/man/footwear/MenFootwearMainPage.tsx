...
const MensFootwearCollection: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const mensFootwearProducts = data.products.filter(
          (product) => product.category.parent?.name === 'Man' && product.category.name === 'Man-Footwear',
        );
        setProducts(mensFootwearProducts);
      } catch (err) {
...
export default MensFootwearCollection;